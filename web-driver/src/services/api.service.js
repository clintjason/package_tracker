...
/**
 * Get a package.
 * @returns {Package} - A package object
 */
...
/**
 * Get a delivery.
 * @returns {Delivery} - A delivery object
 */
export const getOneDelivery = (deliveryId) => {
  return api.get(import.meta.env.VITE_DEV_BASE_URL + `/delivery/${deliveryId}`);
}
